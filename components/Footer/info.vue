<template>
  <div>
    <div>
      ...
      <p class="text-sm font-extralight mb-5 sm:w-1/2">
    ...
    <ul class="font-light">
      <li class="mb-5 font-extralight text-sm">
